...
export class EventService {
  EVENTS = [
    ...
    {id: 2, name: 'ng-nl', date: '4/15/2037', time: '9am',
      ...
      session: [
        {id: 1, name: 'Angular4 Components', presenter: 'Joseph Peter', level: 'intermediate'}
      ]},
    {id: 3, name: 'ng-conf 2037', date: '4/15/2037', time: '9am',
      ...
      session: [
        {id: 1, name: 'Http and Services in Angular4', presenter: 'Joseph Peter', level: 'Beginner'}
      ]},
    {id: 4, name: 'UN Angular Summit', date: '6/10/2037', time: '8am',
      location: {address: 'The UN Angular Center', city: 'New York', country: 'USA'},
      session: [
        {id: 1, name: 'How to do unit testin gin Angular2', presenter: 'Joseph Peter', level: 'Expert'}
      ]},
  ];
